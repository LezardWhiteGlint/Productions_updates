...
def page_navi(Collection,driver,sleep_time,start_date,end_date):
    ...
    url = 'http://data.r2games.com/mobile/?r=complex%2Findex&m=M354&p=mobile&g=bzdxcru&server=ALL&time_start='+start_date.isoformat()+'&time_end='+end_date.isoformat()+'&show=ByDate'
    driver.get(url)
